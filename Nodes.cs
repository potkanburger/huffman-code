...
namespace Huffman
{
    class Nodes
    {
        private KeyValuePair<char, int> _valPair;
        private int _value;
        ...
        public Nodes(KeyValuePair<char, int> val)
        {
            _valPair = val;
            _hasKey = true;
            _children = new List<Nodes>();
        ...
        public KeyValuePair<char, int> getKeyValuePair()
        {
            return (_hasKey) ? _valPair : new KeyValuePair<char, int>();
        }
